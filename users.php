...
<html lang="en">
  ...
  <body>
    ...
    <button class="btn"><a href="adminpage.php" class="text"> Add User</a></button>
        ...
        <?php
            ...
            if($res){
                while($row=mysqli_fetch_assoc($res)){
                    ...
                    <td>'.$password.'</td>
                    <td>
                    <button class="btn"><a href="update.php? updateid='.$id.'" class="text">Update</a></button>
                    <button class="btn"><a href="delete.php? deleteid='.$id.'" class="text">Delete</a></button>
                </td>
                  </tr>';
